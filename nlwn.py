...
# Modified by Michael Gabilondo, 2009
...
#							 for root in h.root_hypernyms()))
	...
	def hypernym_paths(self):
		...
		hypernyms.extend(self.instance_hypernyms())
	...
	def shortest_path_distance(self, other):
		...
		if hypernym_distances_memo.has_key(self):
			dist_list1 = hypernym_distances_memo[self]
		else:
			dist_list1 = self.hypernym_distances()
			hypernym_distances_memo[self] = dist_list1

		dist_dict1 = {}

		if hypernym_distances_memo.has_key(other):
			dist_list2 = hypernym_distances_memo[other]
		else:
			dist_list2 = other.hypernym_distances()
			hypernym_distances_memo[other] = dist_list2
		dist_dict2 = {}
